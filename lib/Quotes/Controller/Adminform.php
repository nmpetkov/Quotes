 ...
 * @version $Id: Adminform.php 437 2010-07-06 13:24:38Z drak $
...
function Quotes_adminform_updateconfig()
{
    ...
    ModUtil::setVar('Quotes', 'itemsperpage', $itemsperpage);

    $enablecategorization = (bool)FormUtil::getPassedValue('enablecategorization', false, 'POST');
    ModUtil::setVar('Quotes', 'enablecategorization', $enablecategorization);

    // let any other modules know that the modules configuration has been updated
    ModUtil::callHooks('module', 'updateconfig', 'Quotes', array('module' => 'Quotes'));
