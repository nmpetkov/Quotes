...
function Quotes_adminapi_create($quote)
{
    ...
    ModUtil::callHooks('item', 'create', $quote['qid'], array('module' => 'Quotes'));
...
function Quotes_adminapi_delete($args)
{
    ...
    ModUtil::callHooks('item', 'delete', $args['qid'], array('module' => 'Quotes'));
...
function Quotes_adminapi_getlinks()
{
    ...
    if (SecurityUtil::checkPermission('Quotes::', '::', ACCESS_EDIT)) {
        $links[] = array('url' => ModUtil::url('Quotes', 'admin', 'view'), 'text' => __('View Quotes List', $dom));
    }
    if (SecurityUtil::checkPermission('Quotes::', '::', ACCESS_ADD)) {
        $links[] = array('url' => ModUtil::url('Quotes', 'admin', 'new'), 'text' => __('Create a Quote', $dom));
    }
    if (SecurityUtil::checkPermission('Quotes::', '::', ACCESS_ADMIN)) {
        $links[] = array('url' => ModUtil::url('Quotes', 'admin', 'modifyconfig'), 'text' => __('Settings', $dom));
    }
